...
//  Stocks
//
//  Created by Francisco Ochoa on 05/11/2021.
//
...
class WatchListTableViewCell: UITableViewCell {
    ...
    static let preferrdHeight:CGFloat = 60
    struct ViewModel {
        let symbol: String
        ...
        let chattViewModel: StockChartView.ViewModel
    }
    ...
    public func configure(with viewModel: ViewModel){
        ...
        //Configure chart
        miniChartView.configure(with: viewModel.chattViewModel)
